...
public class SCS_ProblemGenerator
{
	public static int length = 400, arity = 2;
	public static int minSubstrLen = 20, maxSubstrLen = 30, numOfCopies = 50;
	...
	public static void mainWork(String[] args)
	{
		...
		try
		{
			...
			int[] randString = generateRandomString(length, arity);
//			for (int i = 0; i < randString.length; i++)
//			{
//				System.out.print(randString[i] + " ");
//			}
			int[][] substrings = generateSubstrings(randString, minSubstrLen, maxSubstrLen, numOfCopies);
...
//			System.out.println();
			...
			substrings = pruneSubstrings(substrings);
...
//			System.out.print(retVal[i] + " "); 
	...
	public static int[][] generateSubstrings(int[] superstring, int minSubstrLen,
	...
	public static int[][] pruneSubstrings(int[][] substrings)
	{
		...
		for (int i = 0; i < substrings.length; i++)
		{
			...
			for (int j = i + 1; str1 != null && j < substrings.length; j++)
			{
				...
				if (str2 != null && isSubstring(str1, str2))
				{
...
//							System.out.println(actualLength);
	...
	public static void writeProblem(int[] randString, int[][] substrings, FileWriter outFile)
			throws IOException
	{
